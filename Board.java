...
class Mover
{
  ...
  {
    /* The first statements check that the x and y are inbounds.  The last statement checks the map tosee if it's a valid location */
...
public class Board extends JPanel
{
  ...
  /* For NOT JAR file*/
  Image pacmanImage = Toolkit.getDefaultToolkit().getImage("images\\pacman.jpg"); 
  Image pacmanUpImage = Toolkit.getDefaultToolkit().getImage("images\\pacmanup.jpg"); 
  Image pacmanDownImage = Toolkit.getDefaultToolkit().getImage("images\\pacmandown.jpg"); 
  Image pacmanLeftImage = Toolkit.getDefaultToolkit().getImage("images\\pacmanleft.jpg"); 
  Image pacmanRightImage = Toolkit.getDefaultToolkit().getImage("images\\pacmanright.jpg"); 
  Image ghost10 = Toolkit.getDefaultToolkit().getImage("images\\ghost10.jpg"); 
  Image ghost20 = Toolkit.getDefaultToolkit().getImage("images\\ghost20.jpg"); 
  Image ghost30 = Toolkit.getDefaultToolkit().getImage("images\\ghost30.jpg"); 
  Image ghost40 = Toolkit.getDefaultToolkit().getImage("images\\ghost40.jpg"); 
  Image ghost11 = Toolkit.getDefaultToolkit().getImage("images\\ghost11.jpg"); 
  Image ghost21 = Toolkit.getDefaultToolkit().getImage("images\\ghost21.jpg"); 
  Image ghost31 = Toolkit.getDefaultToolkit().getImage("images\\ghost31.jpg"); 
  Image ghost41 = Toolkit.getDefaultToolkit().getImage("images\\ghost41.jpg"); 
  Image titleScreenImage = Toolkit.getDefaultToolkit().getImage("images\\titleScreen.jpg"); 
  Image gameOverImage = Toolkit.getDefaultToolkit().getImage("images\\gameOver.jpg"); 
  Image winScreenImage = Toolkit.getDefaultToolkit().getImage("images\\winScreen.jpg");
